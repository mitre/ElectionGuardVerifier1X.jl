# 13FG. Well-formed spoiled ballots
...
"13FG. Validation of correctness of spoiled ballots"
function verify_well_formed_spoiled_ballots(er::Election_record)::Answer
    ...
    answer(13, bits2items(acc), "Validation of correctness of spoiled ballots",
           comment, count, failed)
end

function check_selection(ballot::Spoiled_ballot)::Int64
